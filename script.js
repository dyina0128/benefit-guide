...
function renderCards(region) {
  ...
  benefitData[region].forEach(function(item) {
    ...
    button.addEventListener("click", function() {
      ...
      // 구글 애드센스 승인을 타겟팅한 posts 폴더 내부 정적 주소 연동 부분
